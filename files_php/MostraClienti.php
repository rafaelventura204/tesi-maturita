...
<html> 
  ...
  <div id="sfondoImpostazioniAdmin"> 
    ...
    <div id="intestazione"> <!--div intestazione -->
        <h4 style="color:#fff;"> Impostazioni <i style="color:#fff;" class="fa fa-sliders" aria-hidden="true"></i> </h4>
        		<br>
            <p style="color:#fff; font-size: 22px;"> Aggiungi un nuovo cliente: <a style="color:#fff;" href='FormProprietario.php'><i class="fa fa-user-plus" aria-hidden="true"></i></a> </p>
        		<br>
            <p style="color:#fff; font-size: 22px;"> Cerca Cliente: <a style="color:#fff;" href='FormCerca.php'><i class="fa fa-search" aria-hidden="true"></i></a> </p>
        <br><br><br><br>
      <h4> Lista clienti: </h4>
